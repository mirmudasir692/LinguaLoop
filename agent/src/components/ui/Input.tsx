...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const computedType = isPasswordField && showPasswordToggle
      ? isPasswordVisible
        ? 'text'
        : 'password'
      : type;
      ...
      <div className="input-group">
        {label && (
          <label htmlFor={inputId} className="input-label">
            {label}
            {required && <span className="input-required-asterisk" aria-hidden="true"> *</span>}
          </label>
        )}
        ...
        <div className="input-field-container">
          ...
          {isPasswordField && showPasswordToggle ? (
            ...
            >
              {isPasswordVisible ? (
                <svg className="input-eye-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
