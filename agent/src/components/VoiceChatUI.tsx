        ...
        {isAiSpeaking ? (
          <div className="flex flex-col items-center justify-center space-y-1">
            <div className="flex items-center justify-center space-x-1.5 h-6">
              ...
              />
              <div
                className="w-1.5 h-6 bg-blue-600 rounded-full animate-bounce"
              ...
              />
              <div
                className="w-1.5 h-5 bg-blue-600 rounded-full animate-bounce"
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs font-semibold text-blue-600 flex items-center gap-1.5">
                ...
                <span className="text-[10px] text-gray-500 font-normal bg-blue-50 border border-blue-100 px-1.5 py-0.5 rounded">
                  Mic auto-muted
                </span>
              </span>
              {onInterrupt && (
